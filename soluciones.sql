...
SELECT COUNT(*) AS filas_union     FROM (SELECT * FROM inventario_sucursal_norte UNION SELECT * FROM inventario_sucursal_sur)     AS resultado_union;
SELECT COUNT(*) AS filas_union_all FROM (SELECT * FROM inventario_sucursal_norte UNION ALL SELECT * FROM inventario_sucursal_sur) AS resultado_union_all;
