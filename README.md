...
La primera consulta UNION devuelve 10 registros ya se filtro por nombre del producto y existían valores repetidos eliminando el resto de columnas
La segunda consulta UNION ALL devuelve solo 1 registro por que se realizo la suma de todo el stock de ambas tablas
